...
const Copyright = ({className, dark, logo}) => {
    return (
                    ...
                    <div className="tt-col-left">
                        ...
                        <div className="tt-col-item">
                            <div className="tt-box-copyright ht-copy">
                                &copy; Posh and Perfect {new Date().getFullYear()}. Developed by <a
                                href="https://visoroy.com" target="_blank" rel="noopener noreferrer">Visoroy Innovations</a>.
                            </div>
                        </div>
                    </div>
